...
<div id="konten_modal_detail_produk"
    ...
    <div
        ...
        {{-- X --}}
        <div onclick="closeModal_detail_produk()" class="cursor-pointer">
    ...
    <div id="container_tb_terjual"
        ...
        <table class="w-full text-xs min-[390px]:text-sm md:text-base">
            ...
            <tbody id="tb_terjual" class="text-center">
            </tbody>
        </table>
    </div>

    {{-- table tidak terjual --}}
    <div id="container_tb_t_terjual"
        ...
        <table class="w-full text-xs min-[390px]:text-sm md:text-base">
            ...
            <tbody id="tb_t_terjual" class="text-center">
            </tbody>
        </table>
    </div>
