...
<form id="form_add_pegawai" action="{{ route('tambah_pegawai') }}" method="post">
    @csrf
    <div id="konten_modal"
        ...
        <div
            ...
            <h1 class="poppins-medium leading-none">Tambah Pegawai</h1>
        ...
        <div class="w-full flex-grow overflow-auto lg:text-[16px] md:text-[15px] text-[12px]">
            ...
            <div class="block mt-2 min-[374px]:mt-4  ">
                ...
                <div class="flex flex-row">
                    <div class="mx-4">
                        <input value="pria" class="w-4 h-4 rounded mt-1" type="radio" name="gender"
                            id="genderm" {{ old('jenis') == 'genderm' ? 'checked' : '' }}>
                        <label for="genderm">pria</label>
                    </div>

                    <div class="mx-4">
                        <input value="wanita" class="w-4 h-4 rounded mt-1" type="radio" name="gender"
                            id="genderp" {{ old('jenis') == 'genderp' ? 'checked' : '' }}>
            ...
            <div class="block mt-2 min-[374px]:mt-4">
                <p class="poppins-medium text-[#535353] mb-1 min-[374px]:mb-2">Role</p>
            ...
            <div class="block mt-2 min-[374px]:mt-4" id="username" name="username">
                <p class="poppins-medium text-[#535353] mb-1 min-[374px]:mb-2">username</p>
            ...
            <div class="block mt-2 min-[374px]:mt-4" id="password" name="password">
                <p class="poppins-medium text-[#535353] mb-1 min-[374px]:mb-2">password</p>
