...
<div id="konten_modal"
    ...
    <div class="flex flex-col w-full">
            ...
            <table class="w-full text-xs min-[390px]:text-sm md:text-base">
                ...
                <tbody class="text-center bg-white border-[1px] border-[#CCCCCC]">
                    <tr>
                        ...
                        <td class="p-3 md:p-5 text-right" id="uang_kembali"><td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="flex flex-col lg:flex-row w-full p-5 md:p-8">
            ...
            {{-- button --}}
            <div class="flex justify-center lg:justify-end lg:items-center w-full gap-3 mt-7 lg:m-0 md:mt-10 text-xs min-[390px]:text-base md:text-lg">
              <button type="button" class="lg:h-[45%] px-5 py-2 poppins-semibold text-white bg-[#3C3C3C] transition ease-in-out hover:bg-black rounded-[5px]">Cetak</button>
              <button type="button" onclick="closeModal()" class="lg:h-[45%] px-5 py-2 poppins-semibol bg-[#FFB015] hover:bg-[#f5a300] transition ease-in-out rounded-[5px]">Ok</button>
            </div>
        </div>
