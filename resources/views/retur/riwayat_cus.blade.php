...
@section('modal')
    @include('modal.detail_riwayat_retur_cs')
            ...
            <div
                ...
                <div class="flex items-center md:w-1/2 h-full gap-2">
                    ...
                    <form action="" method="GET" id="form_search">
                        <input type="search" id="field_search" name="search" value="{{ $search }}"
                    ...
                    <tbody>
                        @foreach ($data as $index)
                            <tr class="bg-white border-2 outline outline-[1px] outline-[#DCDADA] rounded-md">
                                <td class="text-center p-3">{{ $index->kode_retur_cs }}</td>
                                <td class="text-center p-3">{{ $index->tanggal }}</td>
                                <td class="text-center p-3">{{ $index->barangReturCS->nama_br }}</td>
                                <td class="text-center p-3">{{ $index->QTY }}</td>
                                <td class="text-center p-3">{{ $index->jenis_pengembalian }}</td>
                                <td class="text-center p-3">
                                    <svg onclick="showModal({{ $index }})"
...
@section('otherjs')
    <script src="{{ asset('js/controllers/riwayat_retur_cs.js') }}"></script>
