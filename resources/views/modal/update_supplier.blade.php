...
<form id="form_supplier_edit" action="/supplier/edit" method="POST">
    @csrf
    <div id="konten_modal_edit"
        ...
        <div
            ...
            <h1 class="poppins-medium leading-none">Ubah Data Supplier</h1>

            {{-- X --}}
            <div onclick="closeModalEdit()" class="cursor-pointer">
        ...
        {{-- <!-- konten modal -->
          ...
          <div class="w-full flex-grow overflow-auto lg:text-[16px] md:text-[15px] text-[12px]">
            ...
            <input id="idSupUpdate" name="id_update" type="hidden" placeholder=""
