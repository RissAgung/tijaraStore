...
<div id="konten_modal_wanita"
    ...
    <div
        ...
        {{-- X --}}
        <div onclick="closeModal_wanita()" class="cursor-pointer">
    ...
    <div class="flex max-md:mt-6">
        <div
            ...
            <div onclick="tab_terjual('wanita')" id="tab_terjual_wanita"
                class="cursor-pointer py-1 px-3 rounded-sm transition ease-in-out hover:bg-[#FFB015] bg-[#FFB015]">
                Terjual</div>
            <div onclick="tab_tidak_terjual('wanita')" id="tab_tidak_terjual_wanita"
    ...
    <div id="tb_terjual_wanita"
        ...
        <table class="w-full text-xs min-[390px]:text-sm md:text-base">
            ...
            <tbody class="text-center">
                @foreach ($produk_terjual as $index)
    ...
    <div id="tb_t_terjual_wanita"
        ...
        <table class="w-full text-xs min-[390px]:text-sm md:text-base">
            ...
            <tbody class="text-center">
                ...
                @foreach ($produk_tidak_terjual as $index)
                    @if ($index->kategori === 'wanita')
                        <tr>
                            <td class="p-2 md:p-4 text-left" id="nama_br">{{ $index->nama_br }}</td>
                        </tr>
