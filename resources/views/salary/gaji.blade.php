...
<div class=" h-fit bg-white border-b-2">
        <div class=" flex flex-col px-4 md:px-12 justify-between gap-4 mt-2 md:flex-row py-4">
            ...
            <div id="btn_tambah"
                ...
                <p class="text-black poppins-regular hidden lg:flex">Tambah Gaji</p>
            </div>
                ...
                <tbody>
                    ...
                    @foreach($dataGaji as $salary)
                        <tr class="bg-white border-2 ">
                            <td class="tracking-wide text-center p-3">{{ DateTime::createFromFormat('Y-m-d', $salary->tanggal)->format('d M Y') }}</td>
