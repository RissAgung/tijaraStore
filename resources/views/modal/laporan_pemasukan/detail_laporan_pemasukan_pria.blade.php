...
<div id="konten_modal_pria"
    ...
    <div
        ...
        <h1 class="poppins-medium leading-none">Detail Pakaian Pria</h1>
    ...
    <div class="flex max-md:mt-6">
        <div
            ...
            <div onclick="tab_terjual('pria')" id="tab_terjual"
                class="cursor-pointer py-1 px-3 rounded-sm transition ease-in-out hover:bg-[#FFB015] bg-[#FFB015]">
                Terjual</div>
            <div onclick="tab_tidak_terjual('pria')" id="tab_tidak_terjual"
