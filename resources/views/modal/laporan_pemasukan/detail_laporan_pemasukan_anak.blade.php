...
<div id="konten_modal_anak"
    ...
    <div
        ...
        {{-- X --}}
        <div onclick="closeModal_anak()" class="cursor-pointer">
    ...
    <div class="flex max-md:mt-6">
        <div
            ...
            <div onclick="tab_terjual('anak')" id="tab_terjual_anak"
                class="cursor-pointer py-1 px-3 rounded-sm transition ease-in-out hover:bg-[#FFB015] bg-[#FFB015]">
                Terjual</div>
            <div onclick="tab_tidak_terjual('anak')" id="tab_tidak_terjual_anak"
